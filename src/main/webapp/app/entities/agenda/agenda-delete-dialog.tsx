...
export interface IAgendaDeleteDialogProps extends StateProps, DispatchProps, RouteComponentProps<{ id: string }> {}

export class AgendaDeleteDialog extends React.Component<IAgendaDeleteDialogProps> {
  componentDidMount() {
    this.props.getEntity(this.props.match.params.id);
  }

  confirmDelete = event => {
    this.props.deleteEntity(this.props.agendaEntity.id);
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalFooter>
          ...
          <Button id="jhi-confirm-delete-agenda" color="danger" onClick={this.confirmDelete}>
