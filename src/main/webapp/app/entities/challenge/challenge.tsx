...
export type IChallengeState = IPaginationBaseState;

export class Challenge extends React.Component<IChallengeProps, IChallengeState> {
  ...
  render() {
    const { challengeList, match } = this.props;
    return (
      <div>
